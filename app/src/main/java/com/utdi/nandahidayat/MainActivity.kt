...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rickRecyclerView = findViewById<RecyclerView>(R.id.rv_character)
        rickRecyclerView.setHasFixedSize(true)
        // kemudian val rick ini digunakan untuk mendapatkan elemen dari layout activity_main.xml
        ...
        // dimana setelah respon, maka dilanjutkan dengan mengambil data daftar karakter
